...
public class GuideActivity extends AbsBaseActivity {
    ...
    private void initDot(int i) {
        this.imageDots[0].setBackgroundResource(R.drawable.guide_dots1);
        this.imageDots[1].setBackgroundResource(R.drawable.guide_dots2);
        this.imageDots[2].setBackgroundResource(R.drawable.guide_dots3);
        this.imageDots[3].setBackgroundResource(R.drawable.guide_dots4);
        this.imageDots[i].setBackgroundResource(R.drawable.guide_dots);
    }
    ...
    protected void initListener() {
        this.mViewPager.addOnPageChangeListener(this.mBackListener);
    }
    ...
    class CallBackListener
        ...
        public void onPageScrollStateChanged(int paramInt) {
            if ((GuideActivity.this.currentIndex == 3) && (paramInt == 1)) {
                ...
                Toast.makeText(GuideActivity.this, "谢谢点击", Toast.LENGTH_LONG).show();
            }
        }
