...
public class DateTools {
    ...
    public static String getMyMistakeTime(Context paramContext, long paramLong) {
        ...
        if (l <= 86400000L)
            return paramContext.getResources().getString(R.string.my_mistake_today);
        if ((l > 86400000L) && (l <= 172800000L))
            return paramContext.getResources().getString(R.string.my_mistake_yesterday);
        if ((l > 172800000L) && (l <= 604800000L))
            return longToString(l, true);
        if ((l > 604800000L) && (l <= 1209600000L))
            return paramContext.getResources().getString(R.string.my_mistake_lastweek);
    ...
    public static String getPretime(Context paramContext, long paramLong) {
        ...
        if (l1 < 60000L) {
            ...
            if (l2 == 0L)
                return "刚刚";
            return (int) l2 + paramContext.getResources().getString(R.string.bbs_time_second);
        }
        if ((l1 >= 60000L) && (l1 < 3600000L))
            return (int) (l1 / 60000L) + paramContext.getResources().getString(R.string.bbs_time_min);
        if ((l1 >= 3600000L) && (l1 < 86400000L))
            return (int) (l1 / 3600000L) + paramContext.getResources().getString(R.string.bbs_time_hour);
        if ((l1 >= 86400000L) && (l1 < 2592000000L))
            return (int) (l1 / 86400000L) + paramContext.getResources().getString(R.string.bbs_time_day);
        if ((l1 >= 2592000000L) && (l1 < 31104000000L))
            return (int) (l1 / 2592000000L) + paramContext.getResources().getString(R.string.bbs_time_mon);
        return (int) (l1 / 31104000000L) + paramContext.getResources().getString(R.string.bbs_time_year);
    }
