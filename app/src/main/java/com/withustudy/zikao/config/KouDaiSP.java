package com.withustudy.zikao.config;

import android.content.Context;

import com.withustudy.zikao.tools.LogUtils;
    ...
    public void cacheAnser(int paramInt, HashMap<Integer, String> paramHashMap) {
        ...
        while (true) {
            if (!localIterator.hasNext()) {
                if (!str1.equals(""))
                    this.mContext.getSharedPreferences("koudai", 0).edit().putString(String.valueOf(paramInt), str1).commit();
                return;
            }
